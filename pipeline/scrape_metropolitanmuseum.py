...
metObj_dir = r'C:\Users\Admin\iCloudDrive\CS777 - Big Data Analytics\TermProject\RAW DATA\Metropolitan'
...
try:
    ...
    output_dir = r'C:\Users\Admin\iCloudDrive\CS777 - Big Data Analytics\TermProject\Metropolitan'
    txt_file = os.path.join(output_dir, 'painting_numbers.txt')
